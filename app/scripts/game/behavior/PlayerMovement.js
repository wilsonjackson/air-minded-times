Engine.module('amt.behavior.PlayerMovement',
	...
	function () {
		...
		function PlayerMovement(player) {
			...
			Engine.amt.game.Game.current().on('modechange', self.onModeChange);
		}
		...
		PlayerMovement.prototype.destroy = function () {
			Engine.amt.game.Game.current().off('modechange', this.onModeChange);
		};
		...
		movementMap[Engine.amt.game.Game.MODE.FREE_ROAM] = OmnidirectionalMovement;
		movementMap[Engine.amt.game.Game.MODE.SCROLLING] = UnidirectionalMovement;
