Engine.module('amt.game.Sprites',
	[
		'graphics.sprite.SpriteRepository',
		'graphics.sprite.FontSprite',
		'graphics.sprite.BoxSprite'
	],
	function () {
		'use strict';

		var SpriteRepository = Engine.graphics.sprite.SpriteRepository;
		var FontSprite = Engine.graphics.sprite.FontSprite;
		var BoxSprite = Engine.graphics.sprite.BoxSprite;
